...
import com.michaeltchuang.walletsdk.runtimeaware.wallet.theme.AlgoKitTheme.typography
import com.michaeltchuang.walletsdk.runtimeaware.wallet.widget.button.PeraPrimaryButton
    ...
    Box(
        ...
        Column(
            ...
            Text(
                ...
                color = AlgoKitTheme.colors.textMain,
                text = "Name your account to easily identify it while using the Pera Wallet. These names are stored locally, and can only be seen by you.",
            )
